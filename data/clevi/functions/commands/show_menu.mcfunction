...
## Pick
tellraw @s [{"text":"| "},{"text":"[ pick ]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger command_panel set 5"},"hoverEvent":{"action":"show_text","contents":"Click to run"}},{"text":" ( "},{"text":"-","color":"red","clickEvent":{"action":"run_command","value":"/trigger command_panel set 50"},"hoverEvent":{"action":"show_text","contents":"-2"}},{"text":" [ "},{"score":{"name":"@s","objective":"pick_range"},"color":"yellow","hoverEvent":{"action":"show_text","contents":"Current range"}},{"text":" ] "},{"text":"+","color":"green","clickEvent":{"action":"run_command","value":"/trigger command_panel set 51"},"hoverEvent":{"action":"show_text","contents":"+2"}},{"text":" ) Pick up nearby item within specified range. "}]
