...
## Ob
### (Off)
    tellraw @s[scores={is_observing=0}] [{"text":"| "},{"text":"[ ob ]","bold":true,"color":"dark_green","clickEvent":{"action":"run_command","value":"/trigger command_panel set 3"},"hoverEvent":{"action":"show_text","contents":"click to run"}},{"text":" ","bold":true,"clickEvent":{"action":"run_command","value":"/trigger command_panel set 3"},"hoverEvent":{"action":"show_text","contents":"click to run"}},{"text":"(off)","bold":true,"color":"gray","clickEvent":{"action":"run_command","value":"/trigger command_panel set 3"},"hoverEvent":{"action":"show_text","contents":"click to run"}},{"text":" Toggle to observe mode."}]
### (On)
...
## Leaderboards
tellraw @s [{"text":"| "},{"text":"[ leaderboards ]","clickEvent":{"action":"run_command","value":"/trigger command_panel set 6"},"hoverEvent":{"action":"show_text","contents":"click to run"},"bold":true},{"text":" Open leaderboards menu."}]
